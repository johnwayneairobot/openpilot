...
from selfdrive.car.kia.values import AH, CruiseButtons, CAR  #2018.09.02 johnwayneairobot add for Kia soul
  ...
  def update(self, sendcan, enabled, CS, frame, actuators, \
    ...
    if CS.CP.carFingerprint in (CAR.DUMMY):
         ...
         BRAKE_MAX = 1024 / 4
          ...
          STEER_MAX = 0x05  #2018.09.02 johnwayneairobot, this steering angle TODO: need tune parameter max steering allow, value clip when coming on can
          BRAKE_MAX = 100 #2018.09.02 johnwayneairobot TODO: need to tune for BRAKE_COMMAND_pedal_command, but the value clip when coming out
    else:
      STEER_MAX = 0x1000
      BRAKE_MAX = 1024 / 4
    ...
    if CS.CP.radarOffCan:
      ...
      if (frame % 2) == 0:
        ...
        can_sends.append(
          ...
          #2018.09.02 johnwayneairobot TODO: need to confirm THROTTLE PEDAL command pedal command
